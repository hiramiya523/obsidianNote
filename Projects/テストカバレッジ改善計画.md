...
詳細な指標の説明については、[[Projects/テストカバレッジ指標の説明|テストカバレッジ指標の説明]]を参照してください。
...
- [[Projects/テストカバレッジ指標の説明|テストカバレッジ指標の説明]] - カバレッジ指標の詳細な説明
- [[Projects/AI開発移行計画|AI開発移行計画]] - Phase 1でテスト基盤の構築が重要
- [[Projects/Sveltekit導入計画|SvelteKit導入計画]] - フロントエンド移行計画
