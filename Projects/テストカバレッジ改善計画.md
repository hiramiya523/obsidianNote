...
> [!abstract] 概要
> TOMONIシステム（中間DBプロジェクト）のテストカバレッジを4%から80%以上に向上させるための包括的な改善計画です。
> 
...
詳細な指標の説明については、[[#カバレッジ指標の詳細|カバレッジ指標の詳細]]を参照してください。
...
### Functions/Methods（関数・メソッドカバレッジ）
